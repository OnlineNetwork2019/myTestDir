 ...
 ****************************************************************************************
 */
uint8_t ll_pause_enc_req_handler(uint8_t link_id, struct ll_pause_enc_req *pdu, uint16_t event_cnt)
{
    //Get environment pointer
    struct llc_env_tag *llc_env_ptr = llc_env[link_id];
 ...
 ****************************************************************************************
 */
uint8_t ll_pause_enc_rsp_handler(uint8_t link_id, struct ll_pause_enc_rsp *pdu, uint16_t event_cnt)
{
    //Get environment pointer
    struct llc_env_tag *llc_env_ptr = llc_env[link_id];
    uint8_t status = CO_ERROR_NO_ERROR;
 ...
 ****************************************************************************************
 */
uint8_t ll_enc_req_handler(uint8_t link_id, struct ll_enc_req *pdu, uint16_t event_cnt)
{
    //Get environment pointer
    struct llc_env_tag *llc_env_ptr = llc_env[link_id];
    uint8_t status = CO_ERROR_NO_ERROR;
 ...
 ****************************************************************************************
 */
uint8_t ll_enc_rsp_handler(uint8_t link_id, struct ll_enc_rsp *pdu, uint16_t event_cnt)
{
    //Get environment pointer
    struct llc_env_tag *llc_env_ptr = llc_env[link_id];
    uint8_t status = CO_ERROR_NO_ERROR;
 ...
 ****************************************************************************************
 */
uint8_t ll_start_enc_req_handler(uint8_t link_id, struct ll_start_enc_req *pdu, uint16_t event_cnt)
{
    //Get environment pointer
    struct llc_env_tag *llc_env_ptr = llc_env[link_id];
    uint8_t status = CO_ERROR_NO_ERROR;
 ...
 ****************************************************************************************
 */
uint8_t ll_start_enc_rsp_handler(uint8_t link_id, struct ll_start_enc_rsp *pdu, uint16_t event_cnt)
{
 ...
 ****************************************************************************************
 */
int hci_le_en_enc_cmd_handler(uint8_t link_id, struct hci_le_en_enc_cmd const *param, uint16_t opcode)
{
    // Command status
    uint8_t status = CO_ERROR_NO_ERROR;
    //Get environment pointer
 ...
 ****************************************************************************************
 */
int hci_le_ltk_req_reply_cmd_handler(uint8_t link_id, struct hci_le_ltk_req_reply_cmd const *cmd, uint16_t opcode)
{
 ...
 ****************************************************************************************
 */
int hci_le_ltk_req_neg_reply_cmd_handler(uint8_t link_id, struct hci_le_ltk_req_neg_reply_cmd const *param, uint16_t opcode)
{
    uint8_t status = CO_ERROR_COMMAND_DISALLOWED;
 ...
 ****************************************************************************************
 */
int llc_encrypt_ind_handler(ke_msg_id_t const msgid, struct llc_encrypt_ind const *ind,
 ...
 ****************************************************************************************
 */
int llc_op_encrypt_ind_handler(ke_msg_id_t const msgid, struct llc_op_encrypt_ind *param,
                                ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
