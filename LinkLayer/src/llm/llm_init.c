...
int hci_le_ext_create_con_cmd_handler(struct hci_le_ext_create_con_cmd const *param, uint16_t opcode)
{
...
int hci_le_create_con_cancel_cmd_handler(void const *param, uint16_t opcode)
{
    uint8_t act_id = 0;
