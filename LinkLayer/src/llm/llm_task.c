...
KE_MSG_HANDLER(llm_pub_key_gen_ind, struct ecc_result_ind)
{
...
KE_MSG_HANDLER(llm_dh_key_gen_ind, struct ecc_result_ind)
{
...
/*
__STATIC const struct ke_msg_handler llm_msg_handler_tab[] =
...
KE_MSG_HANDLER_TAB(llm)
{
    ...
    {LLM_PUB_KEY_GEN_IND      , (ke_msg_func_t)llm_pub_key_gen_ind_handler     },
    {LLM_DH_KEY_GEN_IND       , (ke_msg_func_t)llm_dh_key_gen_ind_handler      },
