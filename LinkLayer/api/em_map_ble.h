...
#define EM_BLE_TXDESC_INDEX(act_id, idx)      (BLE_NB_TX_DESC_PER_ACT * act_id + idx) //kenadd 7*act_id+idx
...
#define EM_BLE_DATARXBUF_NB        (BLE_DATA_BUF_NB_RX) //kenadd 8
#define EM_BLE_DATARXBUF_SIZE      (BLE_DATA_BUF_SIZE_RX) //kenadd 260
