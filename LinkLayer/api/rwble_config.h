...
#define BLE_DATA_BUF_NB_RX           (BLE_RX_DESC_NB + 2) //kenadd 8
...
#define BLE_NB_TX_DESC_PER_ADV          (2+BLE_ADV_FRAG_NB_TX) //kenadd 2+5 =7
...
#define BLE_NB_TX_DESC_PER_ACT          (BLE_NB_TX_DESC_PER_ADV) //kenadd 7
...
#define BLE_HCI_ISO_IN_BUF_SIZE          (400)
#endif // (BLE_ISOOHCI)
